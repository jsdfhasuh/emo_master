...
> 历史分析：本文记录现代化改造前的结构和建议。2026-09-10 已完成主题、字体度量节点、折叠栏、工作流标签与内置弹窗重排；当前实现以 [UI 规范](../qt-widgets-qss-guidelines.md) 和 [验证记录](../designer-ui-validation.md) 为准，本文旧字号、颜色和待办不再是当前要求。
